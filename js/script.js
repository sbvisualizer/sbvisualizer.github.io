document.addEventListener('DOMContentLoaded', function() {
            ...
            questions: [
                { 
                    ...
                    modelReplies: {
                        ...
                        "InternVL-V2": "D. Aeromexico and La Liga.",
                        "LLaVA-Next-Video-32B": "D",
                        "LLaVA-OneVision": "D",
                        "LongVA": "D",
                        "Qwen2-VL": "D",
                        "Video-CCAM": "D. Aeromexico and La Liga.",
                    }
                },
                { 
                    time: 53, 
                    ...
                    modelReplies: {
                        ...
                        'LLaVA-OneVision': "C",
                        'MiniCPM-V 2.6': "C",
                        "InternVL-V2": "C. He scored a goal.",
                        "Kangaroo": "C",
                        "LLaVA-OneVision": "C",
                        "LongVA": "C",
                        "Video-CCAM": "C. He scored a goal.",
    ...
    function loadVideo(index) {
        ...
        video.addEventListener('loadeddata', function onLoadedData() {
            ...
            if (currentQuestions.length > 0) {
                showQuestion(currentQuestions[0], false);
            }
            // 移除事件监听器，避免重复添加
        ...
        if (question.taskType === 'Proactive Output') {
            questionContent += `<br>
                <div class="ground-truth">
                    <strong>Ground Truth Response Time: </strong>${formatTime(question.correctOption)}<br>
    ...
    // 如果是第一个问题，暂停视频
    if (question === currentQuestions[0]) {
        playPauseIcon.src = 'icons/play.png';
    }
